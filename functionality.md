# Event Manager — Current Functionality
...
- **Event title** is required; you cannot save an event without a title. If you try, you stay on the form and see an error.
- **Description** is optional.
- **Assigned users** are optional; you can leave an event with no one assigned or change assignments anytime by editing the event.
- **Removing an event** always asks for confirmation before deleting.